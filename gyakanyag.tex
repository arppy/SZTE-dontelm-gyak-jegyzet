...
\paragraph{Feladat:} Tegyük fel, hogy rendelkezünk egy USA gazdaságnak erősen kitett részvényportfólióval.
Aminek a hozama várhatóan negatívan korrelál egy esetleges USA recesszióval.
A részvény portfólió egészét most nem részletezzük és nem összegezzük a feladat másik érdemi részével,
mindez a motiváció érthetősége miatt került bele a feladatba.
Ezért a feladat egyszerűsítése kedvért az alábbi 100\$ készpénz befektetését vizsgáljuk.
...
Ekkor a Figure~\ref{fig:polyusarecession} alapján 250.04\$-t kapunk 2026 végén, amennyiben tényleg recesszió lesz.
Elveszítjük a 100\$-t, ha nem lesz recesszió.
Lehetőségünk van a pénz egy részéből rövid kötvényt venni, amely rész mindkét esetben várhatóan 3\% kamatot fizet.
Legyen a második alternatívánk, hogy 20\$-ból veszünk \("\)Igen\("\)-t és a maradék 80\$-ból pedig rövid kötvényt.
A 80\$ rövid kötvény 2.40\$ kamatot fizet 2026 végéig.
Növekedés esetén csak a kötvényre fordított névérték és a kamat marad meg, recesszió esetén ezen felül az \("\)Igen\("\)-re
51.72\$-t kapunk a Polymarketen (összesen 134.12\$).

\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.3]{PolymarketUSARecession2025-10-07.png}
    \caption{Polymarket USA recesszió 2026 végig (2025.10.07.-én.)}
    \label{fig:polyusarecession}
\end{figure}

A Polymarket árfolyama alapján 0.39 esély van a recesszióra és
...
\hline
  $a_1=$ polymarket \("\)Igen\("\) 100.00 & 250.04 & 0.00 \\
  $a_2=$ polymarket \("\)Igen\("\) 20, rövid kötvény 80 & 134.12 & 82.40 \\
\end{tabular}
\end{center}
